...
class AppRoutes {
  /// Static HTML marketing site (web/landing). Not a Flutter GoRoute.
  static const landing = '/landing/index.html';
...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      // Members (general church list — no meeting context)
      GoRoute(
        path: AppRoutes.member,
        builder: (_, __) => const MembersListScreen(),
      ),

      // Meeting-scoped member list
      GoRoute(
