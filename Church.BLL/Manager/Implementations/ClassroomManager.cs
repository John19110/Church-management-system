...
namespace Church.BLL.Manager.Implementations
{
    public class ClassroomManager : IClassroomManager
    {
        ...
        public async Task<List<ClassroomReadDTO>> GetVisibleClassrooms(int? meetingId = null)
        {
            ...
            {
                return await LoadVisibleClassroomsAsync(meetingId);
            }
            ...
            return await _cache.GetOrCreateAsync(
                ...
                ctx,
                _ => LoadVisibleClassroomsAsync(meetingId));
        }

        private async Task<List<ClassroomReadDTO>> LoadVisibleClassroomsAsync(int? meetingId)
        {
